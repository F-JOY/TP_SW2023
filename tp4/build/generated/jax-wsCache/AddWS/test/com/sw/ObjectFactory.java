 ...
 * generated in the test.com.sw package. 
...
public class ObjectFactory {
    ...
    private final static QName _AdditionResponse_QNAME = new QName("http://sw.com.test/", "AdditionResponse");
    private final static QName _Addition_QNAME = new QName("http://sw.com.test/", "Addition");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: test.com.sw
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw.com.test/", name = "AdditionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw.com.test/", name = "Addition")
